# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 18:21:00 2022
...
from evaluation_metrics import f1,f1_micro
from evaluation_metrics import confusion_matrix_calc
...
def training_model(model,train_data,train_labels,val_data,val_labels,test_data,test_labels,num_epoch,batch_size,num_classes,evaulation_metric):
    ...
    history=model.fit(train_data,train_labels, validation_data=(val_data,val_labels),epochs=num_epoch, batch_size=batch_size,callbacks=[es])
